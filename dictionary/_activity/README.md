...
1. Сформируйте входной список идентификаторов активностей (см. раздел «Input Tables» в [docs/en/devel/DATA_SCHEMA.md](../../docs/en/devel/DATA_SCHEMA.md#input-tables)).
2. Запустите `get-activity-data` согласно инструкции [docs/en/user/USAGE.md](../../docs/en/user/USAGE.md#activity-pipeline-get-activity-data), передав путь к входному CSV и финальному файлу.
