...
1. Подготовьте CSV с `document_chembl_id` (см. раздел «Input Tables» в [DATA_SCHEMA.md](../../docs/en/reference/DATA_SCHEMA.md#input-tables)).
2. Выполните `python -m scripts.get_document_data chembl --input <path>/documents.csv --output <path>/document.csv` согласно инструкции [docs/en/guides/README.md](../../docs/en/guides/README.md#scriptsget_document_datapy).
