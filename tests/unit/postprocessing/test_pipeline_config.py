...
def test_load_pipeline_config__resolves_step_callables(monkeypatch):
    ...
    from library.postprocessing.activities import steps as activity_steps
...
@pytest.mark.parametrize(
    ...
    [
        (
            "activities",
            "library.postprocessing.activities.steps",
        ...
        (
            "assays",
            "library.postprocessing.assays.steps",
        ...
        (
            "targets",
            "library.postprocessing.targets.steps",
