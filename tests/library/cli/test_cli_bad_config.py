...
def test_malformed_config_exits(
    ...
    cfg.write_text(
        ...
        "    iuphar_target_csv: resources/dictionary/_IUPHAR/_IUPHAR_target.csv\n"
        "    iuphar_family_csv: resources/dictionary/_IUPHAR/_IUPHAR_family.csv\n"
        "    uniprot_data_dir: uniprot\n"
        "    targets_type_csv: resources/dictionary/targets_type.csv\n"
    )
