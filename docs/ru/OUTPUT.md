...
(`library.postprocessing.pipeline.targets.run_target_pipeline`) формирует агрегированное
...
CSV и проверяет схему из `library/postprocessing/pipeline/targets/schema.py`.
