...
Во всех примерах запуска следует добавлять `--emit-legacy-artifacts`, чтобы вместе с тремя стандартными CSV появлялся sidecar `.meta.yaml` для трассировки происхождения.
...
_Обновлено для стандартного набора CSV + метаданных 19.10.2025._
