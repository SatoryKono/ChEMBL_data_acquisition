...
дополняет пошаговое описание пайплайнов в разделе [Поток данных ETL](../qa/ETL_DATA_FLOW.md).
...
| QA и наблюдаемость | `data/logs/`, `library/common/log.py`, `library/utils/cli_tools/table_quality_main.py` | Структурированное логирование, профилирование таблиц, диагностика ошибок. |
