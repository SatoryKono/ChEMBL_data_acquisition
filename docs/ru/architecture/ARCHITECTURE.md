...
Подробности о том, как пайплайн test item объединяет parent-molecule словари и
взаимодействует с последующими шагами, приведены в
[руководстве по расширенным сценариям](../guides/ADVANCED_SCENARIOS.md).
