...
вспомогательные утилиты. Для английской версии обратитесь к `docs/en/guides/USAGE.md`.
...
[`sources.chembl.molecule_catalog.cache_path`](../../ru/reference/CONFIG.md#sources-chembl-molecule-catalog); убедитесь,
...
`local.io.output_dir`). Полный список приведён в `docs/ru/reference/CONFIG.md`.
