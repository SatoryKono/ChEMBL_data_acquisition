# Обзор потока данных ETL

> **Languages:** [English](../en/ETL_DATA_FLOW.md) · Русский

Этот документ предоставляет общий обзор потока данных ETL для пайплайнов ChEMBL Data Acquisition. Для подробных диаграмм потоков и технических спецификаций см. [Справочник по потоку данных ETL](./architecture/ETL_DATA_FLOW.md).

## Быстрая навигация

- **[Обзор пайплайнов](#обзор-пайплайнов)** - Сводка всех пайплайнов
- **[Связи между пайплайнами](#связи-между-пайплайнами)** - Как пайплайны соединяются
- **[Источники данных](#источники-данных)** - Внешние сервисы и API

## Подробная документация

Для всесторонних диаграмм потоков и технических деталей обратитесь к:
