...
используют совместимые спецификаторы (`~=`), поэтому обновления исправлений
внутри протестированной минорной ветки поддерживаются, а dev-набор ограничен
верхними границами (`<`), что защищает от неожиданных мажорных апдейтов. CI
прогоняет проверки на минимальной и актуальной версиях из таблицы.
