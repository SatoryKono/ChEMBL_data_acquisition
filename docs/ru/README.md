...
`pyproject.toml` фиксирует поддерживаемые диапазоны. Пакет проверяется на
CPython 3.11 и 3.12; поддержка 3.13 откладывается до обновления зависимостей.
Рабочие зависимости зафиксированы совместимыми диапазонами, поэтому
обновления исправлений внутри минорной версии поддерживаются. CI прогоняет
проверки на минимальной и актуальной версиях из таблицы.
