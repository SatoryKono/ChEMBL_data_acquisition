...
| Observability | `data/logs/`, `library/utils/logging.py`, `library/utils/cli_tools/table_quality_main.py` | Capture structured logs, provide table-quality summaries, and surface validation issues for stakeholders. |
