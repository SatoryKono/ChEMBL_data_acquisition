...
The primary documentation and reference material live alongside this file in the [documentation directory](./).
...
| Language | Checklist |
|----------|-----------|
| English  | [QA_PROCESS_EN.md](./QA_PROCESS_EN.md) |
| Русский  | [QA_PROCESS_RU.md](./QA_PROCESS_RU.md) |
