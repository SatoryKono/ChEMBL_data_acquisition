...
- English
  ...
  - [CLI tool reference](reference/en/CLI_TOOLS.md)
  - [Data schema](reference/en/DATA_SCHEMA.md)
  - [Output layout](reference/en/OUTPUT.md)
- Русский
  - [Матрица настроек](reference/ru/CONFIG.md)
  - [Справочник по CLI](reference/ru/CLI_TOOLS.md)
...
- English
  ...
  - [Changelog](release-notes/en/CHANGELOG.md)
- Русский
