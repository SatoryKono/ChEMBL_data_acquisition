...
[`sources.chembl.molecule_catalog.cache_path`](./CONFIG.md#sources-chembl-molecule-catalog);
...
`CHEMBL_DA_OUTDIR` (maps to `local.io.output_dir`) are available. See `docs/en/CONFIG.md` for the full list.
