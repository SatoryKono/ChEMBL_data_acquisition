...
This index mirrors the English folder structure. Russian equivalents use the
same filenames inside `../ru/`.
...
- [ETL data flow](./architecture/ETL_PROCESS.md)
- [Data model (star schema)](./architecture/DATA_MODEL.md)
- [Dependencies and QC diagram](./architecture/QC_DEPENDENCIES.md)
...
## Development
- [Developer handbook](./DEVELOPER.md)
- [Local environment setup](./development/LOCAL_SETUP.md)
