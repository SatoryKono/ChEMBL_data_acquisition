...
* **`resources/config/config.yaml`** — централизованная конфигурация API, лимитов, путей, справочников и параметров каждой подсистемы.
