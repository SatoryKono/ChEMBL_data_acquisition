...
arguments specify custom paths.【F:scripts/get_target_data.py†L1064-L1108】
...
are preserved.【F:library/metadata.py†L29-L133】
...
* Pandera validation errors are written to `<stem>_failure_cases.csv` via
  ...
  interrupting the main export.【F:library/sidecar.py†L1-L154】
...
simplify diffing across runs.【F:library/table_quality.py†L1-L192】
...
arguments supplied by the pipeline.【F:library/csv_utils.py†L451-L603】
...
columns remain present even for empty exports.【F:library/pipeline_metadata.py†L24-L84】【F:schemas/activities.py†L52-L55】【F:schemas/documents.py†L111-L112】【F:schemas/testitems.py†L41-L42】
...
CSV and schema:【F:scripts/get_document_data.py†L607-L676】【F:library/document_pipeline.py†L160-L208】
...
| `publication_class` | Final label (`review`, `experimental`, `unknown`) chosen by the classifier after comparing weighted tallies against the configured thresholds.【F:library/document_type_classifier.py†L7-L74】 |
...
priority order:【F:scripts/get_activity_data.py†L212-L353】【F:config.yaml†L260-L315】【F:library/config.py†L358-L420】
...
contains:【F:scripts/get_document_data.py†L636-L674】【F:library/document_pipeline.py†L300-L356】
...
salt resolution and boolean flags.【F:scripts/get_testitem_data.py†L36-L299】【F:library/molecule_catalog.py†L43-L136】【F:library/testitem_enrichment.py†L17-L216】【F:config.yaml†L25-L33】
...
without hitting external services.【F:scripts/pipeline_targets_main.py†L43-L141】
