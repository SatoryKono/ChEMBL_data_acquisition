...
`library.processing.document_pipeline.merge_metadata`. The following fields appear in the
CSV and schema:
...
built by `library.processing.document_pipeline.build_quality_report` and serialised via
