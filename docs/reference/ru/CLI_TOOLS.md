...
| `library.utils.cli_tools.csv_utils_main` | `python -m library.utils.cli_tools.csv_utils_main --input data.csv --final-out copy.csv` | Пересериализует произвольные CSV с детерминированным порядком строк. |
