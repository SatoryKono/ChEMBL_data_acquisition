...
| `library.utils.cli_tools.csv_utils_main` | `python -m library.utils.cli_tools.csv_utils_main --input data.csv --final-out copy.csv` | Re-serialise arbitrary CSV files with deterministic ordering. |
