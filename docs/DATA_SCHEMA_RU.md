...
- **Назначение:** нормализованный набор экспериментальных значений активности, полученный через ChEMBL API, дополненный вычисленными границами, структурированными аннотациями и метаданными пайплайна.【F:scripts/get_activity_data.py†L63-L357】【F:library/chembl_assay.py†L62-L111】【F:schemas/activities.py†L16-L78】【F:library/pipeline_metadata.py†L60-L84】
...
- **Назначение:** описание лекарственных веществ/соединений из ChEMBL, дополненное иерархией родитель→соль, структурными полями, данными PubChem, признаками каталога и метаданными пайплайна.【F:scripts/get_testitem_data.py†L36-L356】【F:library/testitem_enrichment.py†L151-L239】【F:schemas/testitems.py†L14-L47】【F:library/pipeline_metadata.py†L60-L84】
