...
def _load_get_data_module() -> ModuleType:
    """Return the authoritative get-data CLI module."""

    return import_module("library.cli.commands.get_data")


_MODULE = _load_get_data_module()
__all__ = _export_module_api(_MODULE)


def __getattr__(name: str) -> object:
    """Delegate attribute access to :mod:`library.cli.commands.get_data`."""
