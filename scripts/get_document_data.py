...
def _load_document_module() -> ModuleType:
    ...
    return import_module("library.cli.commands.get_document_data")
...
def __getattr__(name: str) -> object:
    """Delegate attribute access to :mod:`library.cli.commands.get_document_data`."""
