"""Wrappers around :mod:`library.constants.normalization` helpers."""

from __future__ import annotations

import pandas as pd

from library.constants.normalization import (
...
def normalize_activities(df: pd.DataFrame) -> pd.DataFrame:
    ...
    This is a thin wrapper around :func:`library.constants.normalization.normalize_activities`.
...
def normalize_assays(df: pd.DataFrame) -> pd.DataFrame:
    ...
    This delegates to :func:`library.constants.normalization.normalize_assays`.
    """
...
def normalize_documents(df: pd.DataFrame) -> pd.DataFrame:
    ...
    This delegates to :func:`library.constants.normalization.normalize_documents`.
    """
...
def normalize_targets(df: pd.DataFrame) -> pd.DataFrame:
    ...
    This delegates to :func:`library.constants.normalization.normalize_targets`.
    """
...
def normalize_testitems(df: pd.DataFrame) -> pd.DataFrame:
    ...
    This delegates to :func:`library.constants.normalization.normalize_testitems`.
    """
