"""Shared helpers and compatibility exports for the activity CLI commands."""
...
def _load_entrypoint_module() -> ModuleType:
    """Load and cache the activity CLI entrypoint module."""
...
def ensure_entrypoint_exports(entrypoint: ModuleType | None = None) -> ModuleType:
    """Expose command helpers on the entrypoint module for compatibility."""
    ...
    if original_emit is not None and not getattr(
        original_emit, "_commands_skip_wrapper", False
    ):
