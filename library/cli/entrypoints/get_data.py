...
1. :mod:`library.cli.entrypoints.document`
2. :mod:`library.cli.commands.get_target_data`
3. :mod:`library.cli.entrypoints.assay`
4. :mod:`library.cli.entrypoints.testitem`
5. :mod:`library.cli.entrypoints.activity`
