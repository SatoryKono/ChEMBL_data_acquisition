...
_LAZY_EXPORTS: dict[str, str] = {
    "ReadInputIdsResult": "library.pipelines.testitem.cli:ReadInputIdsResult",
    "TestitemFetchError": "library.pipelines.testitem.cli:TestitemFetchError",
    "TestitemPipelineOptions": "library.pipelines.testitem.cli:TestitemPipelineOptions",
    "TestitemPipelineStageError": "library.pipelines.testitem.cli:TestitemPipelineStageError",
    "_FETCH_ERROR_SAMPLE_SIZE": "library.pipelines.testitem.cli:_FETCH_ERROR_SAMPLE_SIZE",
    "_log_missing_identifier_summary": "library.pipelines.testitem.cli:_log_missing_identifier_summary",
    "_prepare_pubchem_api_cfg": "library.pipelines.testitem.cli:_prepare_pubchem_api_cfg",
    "apply_testitem_enrichment": "library.pipelines.testitem.cli:apply_testitem_enrichment",
    "fetch_testitems": "library.pipelines.testitem.cli:fetch_testitems",
    "finalize_output": "library.pipelines.testitem.cli:finalize_output",
    "integrate_missing_identifiers": "library.pipelines.testitem.cli:integrate_missing_identifiers",
    "read_input_ids": "library.pipelines.testitem.cli:read_input_ids",
    "run_testitem_pipeline": "library.pipelines.testitem.cli:run_testitem_pipeline",
    "PUBCHEM_CID_CACHE_ENCODING": "library.pipelines.testitem.pubchem:PUBCHEM_CID_CACHE_ENCODING",
    "PUBCHEM_COLUMNS": "library.pipelines.testitem.pubchem:PUBCHEM_COLUMNS",
    "_CID_CACHE_MISSING": "library.pipelines.testitem.pubchem:_CID_CACHE_MISSING",
    "_PUBCHEM_CACHE_SCHEMA_VERSION": "library.pipelines.testitem.pubchem:_PUBCHEM_CACHE_SCHEMA_VERSION",
    "_PUBCHEM_SESSION_LOCK": "library.pipelines.testitem.pubchem:_PUBCHEM_SESSION_LOCK",
    "_PUBCHEM_SESSION_SIGNATURE": "library.pipelines.testitem.pubchem:_PUBCHEM_SESSION_SIGNATURE",
    "_load_pubchem_cid_cache": "library.pipelines.testitem.pubchem:_load_pubchem_cid_cache",
    "_merge_pubchem_properties": "library.pipelines.testitem.pubchem:_merge_pubchem_properties",
    "_prepare_pubchem_caches": "library.pipelines.testitem.pubchem:_prepare_pubchem_caches",
    "_prefetch_parents": "library.pipelines.testitem.pubchem:_prefetch_parents",
    "_pubchem_session_signature": "library.pipelines.testitem.pubchem:_pubchem_session_signature",
    "_resolve_pubchem_cids": "library.pipelines.testitem.pubchem:_resolve_pubchem_cids",
    "_write_pubchem_cid_cache": "library.pipelines.testitem.pubchem:_write_pubchem_cid_cache",
    "add_pubchem_data": "library.pipelines.testitem.pubchem:add_pubchem_data",
    "augment_pubchem": "library.pipelines.testitem.pubchem:augment_pubchem",
    "resolve_pubchem_cid": "library.pipelines.testitem.pubchem:resolve_pubchem_cid",
